...
```{r fig.height=3, fig.width=7, message=FALSE, warning=FALSE, eval=FALSE, echo=FALSE}
library(dynamic)
...
- [McNeish, D.](https://sites.google.com/site/danielmmcneish){target="_parent"} & [Wolf, M. G.](https://www.melissagwolf.com/){target="_parent"} (2021). Dynamic Fit Index Cutoffs for Confirmatory Factor Analysis Models.
...
- [Wolf, M. G.](https://www.melissagwolf.com/){target="_parent"} & [McNeish, D.](https://sites.google.com/site/danielmmcneish/){target="_parent"} (2020). Dynamic Model Fit. R Shiny application version 1.1.0.
