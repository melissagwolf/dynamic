...
likertHB2 <- function(model,data,n=NULL,plot=FALSE,manual=FALSE,estimator="ML",reps=250){
  ...
  #Run simulation
  tryCatch(multi_df_likert2(model9,data,n,estimator, reps),
           error=function(err3){
  ...
  results <- multi_df_likert2(model9,data,n,estimator, reps)
  ...
  if(plot){
    ...
    dataMiss<-data_likert2(model9, data, n, reps)
...
#' @method print likertHB2
#' @param x likertHB2 object
